...
def serializer_programa_asignatura(
    ...
    return {
        ...
        "carga_horaria": {
            ...
            "total_teoria_presencial": programa.asignatura.total_teoria_presencial,
            "total_practica_presencial": programa.asignatura.total_practica_presencial,
            "total_teorico_practico_presencial": programa.asignatura.total_teorico_practico_presencial,
            "total_lab_presencial": programa.asignatura.total_lab_presencial,
            "total_teoria_remoto": programa.asignatura.total_teoria_remoto,
            "total_practica_remoto": programa.asignatura.total_practica_remoto,
            "total_teorico_practico_remoto": programa.asignatura.total_teorico_practico_remoto,
            "total_lab_remoto": programa.asignatura.total_lab_remoto,
            "horas_evaluacion": programa.asignatura.horas_evaluacion,
            "carga_rtf": programa.asignatura.carga_rtf,
            "promedio_horas_semanales": programa.asignatura.promedio_horas_semanales,
        },
        "descriptores": {
