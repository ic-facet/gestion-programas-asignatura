...
def serializer_programa_asignatura(
    ...
    return {
        ...
        "carga_horaria": {
            ...
            "teoria_presencial": programa.asignatura.total_teoria_presencial,
            "practica_presencial": programa.asignatura.total_practica_presencial,
            "teorico_practico_presencial": programa.asignatura.total_teorico_practico_presencial,
            "laboratorio_presencial": programa.asignatura.total_lab_presencial,
            "teoria_distancia": programa.asignatura.total_teoria_remoto,
            "practica_distancia": programa.asignatura.total_practica_remoto,
            "teorico_practico_distancia": programa.asignatura.total_teorico_practico_remoto,
            "laboratorio_distancia": programa.asignatura.total_lab_remoto,
        },
        "descriptores": {
